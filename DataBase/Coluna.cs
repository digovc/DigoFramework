...
{
    public class Coluna : Objeto, IComparable<Coluna>
    {
        #region Constantes
        ...
        public Coluna(string strNome, Tabela tbl, EnmTipo enmTipo = EnmTipo.TEXT)
        {
            #region Variáveis
        ...
        public int CompareTo(Coluna objDbColuna)
        {
