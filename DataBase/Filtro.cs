...
namespace DigoFramework.DataBase
{
    public class Filtro : Objeto
    {
        ...
        public Filtro(string sqlFiltro)
        {
            #region Variáveis
        ...
        public Filtro(Coluna cln, string strFiltro)
        {
            #region Variáveis
        ...
        public Filtro(Coluna cln, decimal decFiltro)
        {
            #region Variáveis
        ...
        public Filtro(Coluna cln, int intFiltro)
        {
            #region Variáveis
