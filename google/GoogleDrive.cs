    ...
    public class GoogleDrive : Google
    {
        ...
        public File criarPasta(String strPastaNome, String strPastaDescricao)
        {
            ...
            if (objGooglePasta == null)
            {
                ...
                objGooglePasta.MimeType = Arquivo.getMimeTipo(Arquivo.EnmMimeTipo.APPLICATION_VND_GOOGLE_APPS_FOLDER);
        ...
        public List<File> getListaPastas()
        {
            ...
            {
                if (objGoogleFile.MimeType == Arquivo.getMimeTipo(Arquivo.EnmMimeTipo.APPLICATION_VND_GOOGLE_APPS_FOLDER))
                {
