namespace DigoFramework.Arquivo
{
    ...
    {
        public static string getStrContentType(EnmContentType enmContentType)
        {
        ...
        internal static EnmContentType getEnmContentType(string strExtensao)
        {
            if (string.IsNullOrEmpty(strExtensao))
            {
